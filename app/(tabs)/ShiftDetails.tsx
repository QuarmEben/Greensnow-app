    ...
    <View style = {tw`flex-1 overflow-hidden flex-col items-start px-3.5 py-10 mx-auto w-full bg-zinc-100 max-w-[480px]`} className="flex overflow-hidden flex-col items-start px-3.5 py-4 mx-auto w-full bg-zinc-100 max-w-[480px]">
      ...
      />
       ...
       <View style = {tw`self-stretch w-full`}>
        ...
        <RequiredItems
          requiredItems={[
            { imageUrl: require("../../assets/images/shoe.png"), title: "Worker Boot", subtitle: "More info", description: "Worker boots to protect the feet and to protect the feet and Worker boots to protect the feet and", isRequired: true, isSelectable: false},
  { imageUrl: require("../../assets/images/shoe.png"), title: "Worker Boot", subtitle: "More info", description: "Worker boots to protect the feet and to protect the feet and Worker boots to protect the feet and", isRequired: true, isSelectable: false},
  { imageUrl: require("../../assets/images/shoe.png"), title: "Worker Boot", subtitle: "More info", description: "Worker boots to protect the feet and to protect the feet and Worker boots to protect the feet and", isRequired: true, isSelectable: false}
          ]}
        />
        ...
        >
          <View style = {tw`px-8 py-4 bg-green-700 rounded-xl`}>
            <Text style = {tw`text-xl font-semibold tracking-tight text-white text-center`}>
              Proceed
            </Text>
          </View>
        </TouchableOpacity>
