  ...
  return (
    ...
    <View style = {tw`flex-1 overflow-hidden flex-col items-start px-3.5 py-10 mx-auto w-full bg-zinc-100 max-w-[480px]`} className="flex overflow-hidden flex-col items-start px-3.5 py-4 mx-auto w-full bg-zinc-100 max-w-[480px]">
      ...
      />
        ...
        <View style={tw`z-10 self-center mt-6 text-xs font-semibold tracking-tight leading-6 text-neutral-400`}>
          <Text style={tw`z-10 self-center mt-6 text-xs font-semibold leading-6 text-neutral-400`}>Gained</Text>
        </View>

        <View style={tw`flex flex-row gap-2.5 items-center self-center max-w-full text-xs tracking-tight text-center text-zinc-600 w-[193px]`}>
          
<View style={tw`flex flex-row gap-0.5 items-center self-stretch my-auto`}>
    <Image
      source={ require("../../assets/images/greenstar_icon.png") }
      style={tw`object-contain shrink-0 self-stretch my-auto w-10 aspect-square`}
    />
    <View style={tw`self-stretch my-auto`}>
      <Text style={tw`self-stretch my-auto text-xs tracking-tight text-center text-zinc-600`}>+40 Rating</Text>
    </View>
    </View>

    <View style={tw`flex flex-row gap-0.5 items-center self-stretch my-auto`}>
    <Image
      source={ require("../../assets/images/greencheck_icon.png") }
      style={tw`object-contain shrink-0 self-stretch my-auto w-10 aspect-square`}
    />
    <View style={tw`self-stretch my-auto`}>
      <Text style={tw`self-stretch my-auto text-xs tracking-tight text-center text-zinc-600`}>+35 Rank</Text>
    </View>
  </View>
        </View>
