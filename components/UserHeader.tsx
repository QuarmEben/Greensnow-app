...
const stats = [
  { iconUrl: require("../assets/images/star.png"), count: 0 },
  { iconUrl: require("../assets/images/rating.png"), count: 0 }
];


export const UserHeader: React.FC<ProfileProps> = ({ avatarUrl, username }) => {
  return (
